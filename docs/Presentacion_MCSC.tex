...
\begin{frame}{Ejemplo Ilustrativo}
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                \item $\{f_1, f_2, f_3\}$: Costo 150
                \item $\{f_2, f_3\}$: Costo 100 \checkmark
                \item $\{f_1, f_3\}$: Costo 110 $\times$
                \item $\{f_1, f_2\}$: Costo 90 $\times$
            \end{itemize}
        \end{column}
    \end{columns}
    \vspace{0.3cm}
    \begin{alertblock}{Solución Óptima}
        $\{f_2, f_3\}$ con costo total de 100, cubriendo todos los requisitos al mínimo costo.
    \end{alertblock}
\end{frame}
