...
\begin{frame}{Análisis Experimental}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{tabular}{l|ccc}
                \toprule
                \textbf{m} & \textbf{Greedy} & \textbf{Genet.} & \textbf{Híbrido} \\
                \midrule
                150 & 56.0 & 56.0 & \textbf{56.0} \\
                500 & 81.0 & 73.0 & \textbf{67.0} \\
                750 & 84.0 & 65.0 & \textbf{65.0} \\
                1000 & 83.0 & 86.0 & \textbf{81.0} \\
                \bottomrule
            \end{tabular}
            }
        \end{column}
        \begin{column}{0.5\textwidth}
            ...
            \begin{tabular}{l|ccc}
                \toprule
                \textbf{m} & \textbf{FB} & \textbf{Híbrido} & \textbf{LS} \\
                \midrule
